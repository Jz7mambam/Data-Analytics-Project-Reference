...
scatter3D(x=values$am, y=values$rr, z=values$clv, phi=0, btw="g",type="h", ticktype="detailed", pch=19, cex=0.5, 
          xlab="margin",ylab="retention rate", zlab="net clv")
...
shapiro.test(customers)   # shapiro -wilk test on normality assumption
